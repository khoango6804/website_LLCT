  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      const botResponse = {
        ...
        type: 'bot',
        content: 'Cảm ơn bạn đã hỏi! Tôi đang xử lý câu hỏi của bạn...',
        timestamp: new Date()
      };
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Trợ lý AI học tập</h1>
              <p className="text-gray-600 mt-1">Hỗ trợ học tập thông minh với AI</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Loại trợ lý</h2>
