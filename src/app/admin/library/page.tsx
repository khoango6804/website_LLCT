...
export default function AdminLibraryPage() {
  ...
  const sidebarItems = [
    ...
    { id: 'library', label: 'Thư viện môn học', icon: BookOpen },
        ...
        <div className="flex-1 flex flex-col">
          ...
          <main className="flex-1 p-6">
            ...
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-3xl font-bold text-gray-900">Thư viện môn học</h2>
                ...
                <div key={section.code} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  ...
                  {section.items.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <h4 className="text-lg font-semibold text-gray-900 mb-2">Chưa có giáo trình</h4>
                      <p className="text-gray-600 mb-6">Hiện tại môn học này chưa có tài liệu nào, hãy cập nhập ngay nào!</p>
