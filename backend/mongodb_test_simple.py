"""
Simple MongoDB connection test without emojis
"""
import asyncio
...
async def test_mongodb():
    ...
    try:
        ...
        print(f"SUCCESS: Insert test document: {result.inserted_id}")
        ...
        # Close connection
        client.close()
        print("SUCCESS: MongoDB connection test completed successfully!")
